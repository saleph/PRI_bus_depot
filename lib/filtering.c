...
List filter_buses_by_side_no(List* the_list, int side_no)
{
    ...
    occurences = find_occurrences(the_list, &side_no, get_side_no, side_no_cmp);
    return occurences;
}
...
{
    static List occurences;
    occurences = find_occurrences(the_list, &line_no, get_line_no, line_no_cmp);
    return occurences;
}
...
{
    static List occurences;
    occurences = find_occurrences(the_list, driver_name, get_driver_name, drivers_names_cmp);
    return occurences;
}
...
{
    static List occurences;
    occurences = find_occurrences(the_list, driver_pesel, get_driver_pesel, drivers_pesels_cmp);
    return occurences;
}
...
{
    static List occurences;
    occurences = find_occurrences(the_list, depot_name, get_depot_name, names_cmp);
    return occurences;
}
